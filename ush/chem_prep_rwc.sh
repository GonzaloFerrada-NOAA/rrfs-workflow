...
#
INPUTDIR=${CHEM_INPUT}/emissions/anthro/raw/NEMO/RWC/total/
NARR_INPUTDIR=${CHEM_INPUT}/aux/narr_reanalysis_t2m/raw/

NARR_OUTPUTDIR=${DATA}
OUTPUTDIR=${DATA}
#TODO:
#NARR_OUTPUTDIR=${CHEM_INPUT}/aux/narr_reanalysis_t2m/processed/
#OUTPUTDIR=${CHEM_INPUT}/emissions/anthro/processed/NEMO/RWC/total
#
mkdir -p "${OUTPUTDIR}" 
